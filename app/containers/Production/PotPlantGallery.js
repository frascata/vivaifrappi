...
const IMAGES = [
  'allevamento_in_vaso_01',
  'allevamento_in_vaso_02',
  'allevamento_in_vaso_03',
  'allevamento_in_vaso_04',
  'allevamento_in_vaso_05',
  'allevamento_in_vaso_06',
  'allevamento_in_vaso_07',
  'allevamento_in_vaso_08',
  'allevamento_in_vaso_09',
  'allevamento_in_vaso_10',
  'allevamento_in_vaso_11',
  'allevamento_in_vaso_12',
];
...
function PotPlantGallery() {
  return (
    <Gallery images={PHOTO_SET}/>
  );
}

export default PotPlantGallery;
